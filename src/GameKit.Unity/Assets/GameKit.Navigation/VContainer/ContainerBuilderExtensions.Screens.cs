...
namespace GameKit.Navigation.VContainer
{
    public static partial class ContainerBuilderExtensions
    {
        ...
        {
            builder.RegisterStackNavigator<PageNavigator, IPage>(configuration, name);
        }
        ...
        {
            builder.RegisterStackNavigator<DialogNavigator, IDialog>(configuration, name);
        }

        private static void RegisterStackNavigator<T, TScreen>(
            this IContainerBuilder builder,
