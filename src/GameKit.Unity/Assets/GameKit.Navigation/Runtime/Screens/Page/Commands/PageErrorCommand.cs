...
namespace GameKit.Navigation.Screens.Page.Commands
{
    ...
    public readonly struct PageErrorCommand : ICommand
    {
        ...
        public PageErrorCommand(string pageId, PageOperation operation, string errorCode, string message,
        ...
        {
            return
                $"PageErrorCommand(PageId: {PageId}, Operation: {Operation}, ErrorCode: {ErrorCode}, Message: {Message}, Exception: {Exception?.Message})";
        }
    }
}